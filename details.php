        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 order-md-2">
                    ...
                    <?php if($descuento > 0) { ?>
                        <p style="color: red;"><del><?php echo MONEDA . number_format($precio, 2, '.', ','); ?></del></p>
                        <h2>
                    ...
                    <?php } else { ?>
                        ...
                        <h2 style="color: green;"><?php echo MONEDA . number_format($precio, 2, '.', ','); ?></h2>
                    ...
                    <div class="d-grid gap-3 col-10 mx-auto">
                        ...
                        <button class="btn btn-primary" type="button" 
                            onclick="addProducto(<?php echo $id; ?>, cantidad.value, '<?php echo $token_tmp; ?>')"> Agregar al carrito 
                        </button>
